...
export default function PlanetariumNavbar({
  ...
  const navButtonBase =
    "group flex items-center gap-1.5 rounded-full border border-slate-700/60 bg-[rgba(var(--primary-bg-rgb),0.45)] text-slate-300/90 hover:border-primary-accent/45 hover:bg-[rgba(var(--primary-bg-rgb),0.65)] hover:text-white transition-all duration-200 active:scale-95 text-[11px] font-semibold uppercase tracking-[0.08em] shadow-sm";

  const navButtonActive =
    "border-primary-accent/65 bg-primary-accent/20 text-white shadow-[0_0_12px_rgba(94,159,255,0.35)]";
  ...
  return (
    ...
    >
      ...
      {activeMenu === "planets" && (
        <div className="pointer-events-auto mb-2.5 w-full sm:w-auto max-w-full rounded-2xl border border-slate-700/60 bg-[linear-gradient(165deg,rgba(var(--primary-bg-rgb),0.94),rgba(20,28,40,0.85))] p-3 shadow-[0_15px_35px_-10px_rgba(0,0,0,0.8)] backdrop-blur-xl animate-in fade-in slide-in-from-bottom-3 duration-200">
          <div className="flex items-center justify-between gap-3 border-b border-slate-700/50 pb-2 mb-2 px-1">
              ...
              return (
                <button
                  ...
                  className={`flex flex-shrink-0 items-center gap-2 rounded-xl px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.06em] transition-all duration-200 ${
                    isSelected
                      ? "bg-primary-accent/25 border border-primary-accent text-white shadow-[0_0_10px_rgba(94,159,255,0.4)] scale-105"
                      : "bg-[rgba(var(--primary-bg-rgb),0.4)] border border-slate-700/60 text-slate-300 hover:bg-[rgba(var(--primary-bg-rgb),0.7)] hover:border-primary-accent/35 hover:text-white"
                  }`}
                >
                  <span
      ...
      {activeMenu === "layers" && (
        <div className="pointer-events-auto mb-2.5 w-72 rounded-2xl border border-slate-700/60 bg-[linear-gradient(165deg,rgba(var(--primary-bg-rgb),0.94),rgba(20,28,40,0.85))] p-3 shadow-[0_15px_35px_-10px_rgba(0,0,0,0.8)] backdrop-blur-xl animate-in fade-in slide-in-from-bottom-3 duration-200">
          <div className="flex items-center justify-between border-b border-slate-700/50 pb-2 mb-2 px-1">
          ...
          <div className="flex flex-col gap-1.5">
            <button
              ...
              className={`flex items-center justify-between rounded-xl px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.06em] transition ${
                settings.showGrid
                  ? "bg-secondary-accent/20 border border-secondary-accent text-white shadow-[0_0_8px_rgba(199,146,234,0.3)]"
                  : "bg-[rgba(var(--primary-bg-rgb),0.4)] border border-slate-700/60 text-slate-300 hover:bg-[rgba(var(--primary-bg-rgb),0.7)] hover:border-slate-500/80 hover:text-white"
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center justify-between rounded-xl px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.06em] transition ${
                settings.showOrbits
                  ? "bg-primary-accent/20 border border-primary-accent text-white shadow-[0_0_8px_rgba(94,159,255,0.3)]"
                  : "bg-[rgba(var(--primary-bg-rgb),0.4)] border border-slate-700/60 text-slate-300 hover:bg-[rgba(var(--primary-bg-rgb),0.7)] hover:border-slate-500/80 hover:text-white"
              }`}
            >
              <span className="flex items-center gap-2">
      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-1.5">
          <button
            type="button"
            onClick={onSlower}
            className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full border border-slate-700/60 bg-[rgba(var(--primary-bg-rgb),0.45)] text-slate-300 transition hover:border-primary-accent/40 hover:text-white active:scale-95"
          ...
          <button
            ...
            className="flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full border border-primary-accent/50 bg-primary-accent/20 text-white transition hover:border-primary-accent hover:bg-primary-accent/30 active:scale-95 shadow-sm"
          ...
          <button
            type="button"
            onClick={onNow}
            className="rounded-full border border-slate-700/60 bg-[rgba(var(--primary-bg-rgb),0.45)] px-2 sm:px-2.5 py-1 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-slate-200 transition hover:border-primary-accent/40 hover:text-white active:scale-95"
